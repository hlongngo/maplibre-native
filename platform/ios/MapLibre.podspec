Pod::Spec.new do |s|
    ...
    s.platform = :ios
    s.source = {
        :http => "https://github.com/maplibre/maplibre-native/releases/download/ios-v#{version.to_s}/BeMap.dynamic.xcframework.zip",
        :type => "zip"
    }
    s.social_media_url  = 'https://mastodon.social/@maplibre'
    s.ios.deployment_target = '12.0'
    s.ios.vendored_frameworks = "BeMap.xcframework"
end
